...
$ActualizarSalida=$conexion->prepare("UPDATE museoNaturales_salidas SET fecha_salida=:1,curso_salida=:2,idInstitucion_salida=:3,cantidad_salida=:4 WHERE id_salida=:5");
